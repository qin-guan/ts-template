...
type CustomLogger = {
  info: (params: Omit<CustomLoggerParams, 'error'>) => Logger
  error: (params: CustomLoggerParams) => Logger
  warn: (params: CustomLoggerParams) => Logger
}
  ...
  return {
    ...
    transports: [
      new transports.Console({
        silent: config.get('nodeEnv') === NodeEnv.Test,
      }),
    ],
    exitOnError: false,
  }
